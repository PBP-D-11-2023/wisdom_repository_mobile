...
class DetailPinjamBuku extends StatelessWidget {
  ...
  Future<Map<String, dynamic>> fetchItem(CookieRequest request) async {
    var response = await request
        .get('http://localhost:8000/borrow/peminjamanjsonidbuku/$idBuku');
    return response;
  }
                          ...
                          Container(
                            ...
                            child: Hero(
                              ...
                              child: Padding(
                                ...
                                child: Image.network(jsonData["gambar"]),
                              ),
                            ),
                          ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              jsonData["final"]
                                  ...
                                  : Text(
                                      '', // You can use an empty string or provide a default message
                                      style: TextStyle(fontSize: 16),
                                    ),
                              jsonData["final"]
                                  ? Text(
                                       ...
                                       jsonData["final"]
                                        ...
                                        onPressed: () async {
                                          final response = await request.postJson(
                                            "http://localhost:8000/borrow/peminjamanflutter/",
                                            jsonEncode(<String,
                                             String>{
